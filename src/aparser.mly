...
reaction:
  | i=ID PONCTUATOR_COLON l1=non_nullable_mol_list PONCTUATOR_ARROW l2=non_nullable_mol_list PONCTUATOR_SEPARATOR c=non_nullable_conc_list PONCTUATOR_DASH v=VALUE PONCTUATOR_SEMICOLON { Atypes.reac_table_length := !Atypes.reac_table_length + 1; Reaction(i,l1,l2,c,v) } (* increasing the number of reactions we have seen too *)
